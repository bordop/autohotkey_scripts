...
win_resize()
{
	...
	WinMove, A,,A_ScreenWidth/4, A_ScreenHeight/4, 1200, 810
	Return
}
...
;=============== obtain cursor location from control ===============
cursor_loc()
{
  global caretX, caretY, homeWin
  WinGetActiveTitle, homeWin
  caretX := A_CaretX
  caretY := A_CaretY
  ; msgbox, 0, Cursor Location, %homeWin%: x%caretX% y%caretY%, 3
  Return
}
...
{
  WinActivate, %homeWin%
  WinWaitActive, %homeWin%
  Click, %caretX%, %caretY%
}



;**********     Click and return mouse to location      **********
...
;**************      return window title and assign to winVar      **************

getTitle()
{
WinGetActiveTitle, winTitle
msgbox, 0, Active Window Title, %winTitle%, 2
Clipboard := winTitle
Return
}
Return
...
; See which window the mouse is over (pass wintitle)
